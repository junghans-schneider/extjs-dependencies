...
// for https://github.com/cpak/grunt-extjs-dependencies (commit 775fd22)
//
// We removed the dependencies to grunt in order to make this parser usable in non-grunt environments.
//
...
exports.init = function (grunt, opts) {
    ...
    function getClassData(src) {
        ...
        output.dependencies = unique(output.dependencies);
